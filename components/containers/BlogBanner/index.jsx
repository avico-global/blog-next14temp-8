...
export default function BlogBanner({ myblog, imagePath }) {
  return (
    <div className="relative h-[30vh] lg:h-[60vh] mt-3 mx-auto max-w-[1300px] text-white">
      {/* Background Image */}
      <Image
      ...
      <div className="absolute inset-0 flex items-end justify-center  bg-gradient-to-t from-black/60 to-transparent">
        <div className="text-center px-4 lg:px-6">
          ...
          <h1
            style={{ fontSize: myblog?.value?.titleFontSize || 30 }}
            className="font-bold capitalize  text-white text-center"
          >
            {myblog?.value.title}
          </h1>
          <div className="text-gray-300 flex items-center justify-center gap-4 mt-2 mb-4">
