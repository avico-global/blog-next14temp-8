...
export const getDomain = (host) => {
  // const defaultDomain = "217towing.sitebuilderz.com";
  const defaultDomain = "best-price-towing.sitebuilderz.com";
  // const defaultDomain = "gas-delivery-services.sitebuilderz.com";
